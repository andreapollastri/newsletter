...
- **`Message::scopeExcludeSentTestingOnly()`** — new reusable Eloquent scope centralising the filtering logic; dashboard widgets already excluded testing-only via `forStatistics()`.
